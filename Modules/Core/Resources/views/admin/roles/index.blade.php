      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a class="btn btn-default btn-sm" href="{!! route('admin.roles.create') !!}"
             title="{{ trans('core::admin/roles/general.button.create') }}">
            <i class="fa fa-plus-square"></i>
          </a>
          &nbsp;
          <a class="btn btn-default btn-sm" href="#"
             onclick="document.forms['frmRoleList'].action = '{!! route('admin.roles.enable-selected') !!}';  document.forms['frmRolesList'].submit(); return false;"
             title="{{ trans('core::general.button.enable') }}">
            <i class="fa fa-check-circle-o"></i>
          </a>
          &nbsp;
          <a class="btn btn-default btn-sm" href="#"
             onclick="document.forms['frmRoleList'].action = '{!! route('admin.roles.disable-selected') !!}';  document.forms['frmRolesList'].submit(); return false;"
