    ...
    <div class='col-md-12'>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          &nbsp;
          <a class="btn btn-default btn-sm" href="{!! route('admin.staff.create') !!}"
             title="{{ trans('core::admin/staff/general.button.create') }}">
            <i class="fa fa-plus-square"></i>
          </a>
          &nbsp;
          <a class="btn btn-default btn-sm" href="#"
             onclick="document.forms['frmStaffList'].action = '{!! route('admin.staff.enable-selected') !!}';  document.forms['frmStaffList'].submit(); return false;"
             title="{{ trans('core::general.button.enable') }}">
            <i class="fa fa-check-circle-o"></i>
          </a>
          &nbsp;
          <a class="btn btn-default btn-sm" href="#"
             onclick="document.forms['frmStaffList'].action = '{!! route('admin.staff.disable-selected') !!}';  document.forms['frmStaffList'].submit(); return false;"
             title="{{ trans('core::general.button.disable') }}">
            <i class="fa fa-ban"></i>
          </a>
