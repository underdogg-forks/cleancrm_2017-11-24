    ...
    <div class='col-md-12'>
      ...
      <!-- Custom Tabs -->
            ...
            <div class="tab-pane" id="tab_settings">
              ...
              <div class="form-group">
                ...
                <label class="radio-inline"><input type="radio" name="time_format" value="12"
                                                   {{("12"==$time_format)?'checked="checked"':''}} readonly="readonly">{{trans('admin/staff/general.options.12_hours')}}
                </label>
                <label class="radio-inline"><input type="radio" name="time_format" value="24"
                                                   {{("24"==$time_format)?'checked="checked"':''}} readonly="readonly">{{trans('admin/staff/general.options.24_hours')}}
                </label>
              </div>
        ...
        <div class="form-group">
          ...
          <a href="{!! route('admin.staff.edit', $staff->id) !!}" title="{{ trans('general.button.edit') }}"
