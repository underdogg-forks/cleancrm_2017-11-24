  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
        <li @yield('AdminPanel')><a data-target="#tabAdminPanel"
                                    href="{{url('/adminpanel')}}">{!! Lang::get('core::lang.adminpanel') !!}</a></li>
        <li @yield('StaffPanel')><a data-target="#tabStaffPanel"
                                    href="{{url('/staffpanel')}}">{!! Lang::get('core::lang.staffpanel') !!}</a></li>
        <li @yield('TicketsPanel')><a data-target="#tabTicketsPanel"
                                      href="{{url('/ticketspanel')}}">{!! Lang::get('tickets::lang.ticketspanel') !!}</a>
        </li>
        <li @yield('EmailPanel')><a data-target="#tabMailPanel"
                                    href="{{url('/mailpanel')}}">{!! Lang::get('email::lang.mailpanel') !!}</a></li>
        <li @yield('RelationsPanel')><a data-target="#tabRelPanel"
                                        href="{{url('/relationspanel')}}">{!! Lang::get('relations::lang.relationspanel') !!}</a>
        <li @yield('KnowledgeBase')><a data-target="#tabKbPanel"
                                       href="{{url('/kbpanel')}}">{!! Lang::get('knowledgebase::lang.kbpanel') !!}</a>
        </li>
      </ul>
