        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
                    ...
                    <li @yield(
                    'Dashboard')><a data-target="#tabA" href="{{url('/adminpanel')}}">{!!
                        Lang::get('core::lang.adminpanel') !!}</a></li>
                    <li @yield(
                    'Users')><a data-target="#tabB" href="#">users</a></li>
                    <li @yield(
                    'Tickets')><a data-target="#tabC" href="#">tickets</a></li>
                    <li @yield(
                    'Tools')><a data-target="#tabD" href="#">tools</a></li>
                    <li @yield(
                    'Settings')><a data-target="#tabE" href="{!! url('/adminpanel/settings') !!}">{!!
                        Lang::get('core::lang.settings') !!}</a>
                    </li>
                </ul>
                ...
                <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
                    <li @yield(
                    'Dashboard')><a data-target="#tabAdminPanel" href="{{url('/adminpanel')}}">{!!
                        Lang::get('core::lang.adminpanel') !!}</a></li>
                    <li @yield(
                    'Staff')><a data-target="#tabStaffPanel" href="{{url('/staffpanel')}}">{!!
                        Lang::get('core::lang.staffpanel') !!}</a></li>
                    <li @yield(
                    'Tickets')><a data-target="#tabTicketsPanel" href="{{url('/ticketspanel')}}">{!!
                        Lang::get('tickets::lang.ticketspanel') !!}</a></li>
                    <li @yield(
                    'Email')><a data-target="#tabMailPanel" href="{{url('/mailpanel')}}">{!!
                        Lang::get('email::lang.mailpanel') !!}</a></li>
                    <li @yield(
                    'KnowledgeBase')><a data-target="#tabKbPanel" href="{{url('/kbpanel')}}">{!!
                        Lang::get('knowledgebase::lang.kbpanel') !!}</a>
                    </li>
                </ul>
                    ...
                    <li class="dropdown staff staff-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="staff-footer">
                                ...
                                <div class="pull-left">
                                    {!! link_to_route('staff.profile', 'Profile', [], ['class' => "btn btn-default
                                    btn-flat"]) !!}
                                </div>
                                @endif
