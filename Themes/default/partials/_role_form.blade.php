...
<div class="nav-tabs-custom">
  <ul class="nav nav-tabs">
    ...
    <li class=""><a href="#tab_staffs" data-toggle="tab" aria-expanded="false">{!! trans('general.tabs.staff') !!}</a>
    </li>
  </ul>
            ...
            @foreach($role->staff as $staff)
              <tr>
                ...
                <td style="text-align: right">
                  <a class="btn-remove-staff" href="#" title="{{ trans('general.button.remove-staff') }}"><i
